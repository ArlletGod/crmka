        ...
        <div class="card kpi-card border-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">New Contacts (Last 30 Days)</div>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <div class="card kpi-card border-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Deals Won (Last 30 Days)</div>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <div class="card kpi-card border-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Revenue (Last 30 Days)</div>
...
<div class="row">
    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Pipeline Overview</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">My Upcoming Tasks</h6>
            </div>
            <div class="card-body">
                <?php if (empty($tasks)): ?>
                    <p class="text-center">No upcoming tasks. Great job!</p>
                <?php else: ?>
                ...
                <?php endif; ?>
                 <a href="/tasks" class="btn btn-primary btn-sm mt-3">View All Tasks</a>
            </div>
        </div>
    </div>
</div>
